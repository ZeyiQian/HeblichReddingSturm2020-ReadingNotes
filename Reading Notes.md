...
*  Assumption 
    ...
    + sets of points connected to each transport network at time _t_:  $$\tilde{s}_t^OR，\tilde{s}_t^UR, \tilde{s}_t^OT$$ (OR, UR, and OT indicate overground railways, underground railways, and omnibuses and trams,)
